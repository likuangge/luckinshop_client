    ...
    <body>
        <div>
            <el-form v-show="Login === 'SignIn'" :model="SignIn" label-width="7em" ref="SignIn" :rules="signin_rules">
                ...
                <el-form-item>
                    <a @click="Login = 'FindPassword'" style="cursor: pointer">忘记密码？</a>
                </el-form-item>
                <el-form-item>
                    <div>
                        <button type="submit" @click.prevent="signin('SignIn')">登录</button>
                        <button type="button" @click="Login='SignUp'">注册</button>
                    </div>
                </el-form-item>
            </el-form>
            <el-form v-show="Login === 'SignUp'" :model="SignUp" :rules="signup_rules" label-width="7em" ref="SignUp">
                ...
                <el-form-item>
                    <div class="center">
                        <button type="submit" @click.prevent="signup('SignUp')">
                            <div>确认注册</div>
                        </button>
                        <button type="button" @click="Login='SignIn'">
                            <div>返回登录</div>
                        </button>
                    </div>
                </el-form-item>
            ...
            <el-form v-show="Login === 'FindPassword'" :model="FindPasswrod" label-width="7em" ref="FindPassword">
                ...
                <el-form-item>
                    <div>
                        <button type="submit" @click.prevent="sendMail('FindPassword')">发送邮件</button>
                        <button type="button" @click="Login='SignIn'">返回登录界面</button>
                    </div>
                </el-form-item>
            </el-form>
        </div>
...
<script>
    ...
    import {reqSignup,reqPhoneCode,reqSendMail} from '../../api'
    export default {
        name: "Login",
        data () {
